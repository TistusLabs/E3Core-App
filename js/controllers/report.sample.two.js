app.controller('SampleTwoController', ['$scope', '$rootScope', '$state', '$timeout', '$http', '$state', '$helpers', '$systemUrls', sampletwoController]);

function sampletwoController($scope, $rootScope, $state, $timeout, $http, $state, $helpers, $systemUrls) {
